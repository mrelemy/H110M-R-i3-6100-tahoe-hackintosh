...
---
![OpenCore](https://img.shields.io/badge/OpenCore-1.0.6-blue) ![macOS](https://img.shields.io/badge/macOS-26.3-green)
...
Select option 3 and enter iMac18,1
IMPORTANT: reminder that you need an invalid serial! to check copy and paste the second part saying Serial: XXXXX.. in Apple's Check Coverage Page, if you get a red message saying "We're sorry, we're unable to check coverage for this serial number." then you're good to go! Otherwise, go back and restart from step 2 (more info here)
